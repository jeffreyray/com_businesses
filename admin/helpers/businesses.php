...
class BusinessesHelper
{
	...
	public static function addSubmenu($vName)
	{
		JSubMenuHelper::addEntry(
			JText::_('COM_BUSINESSES_SUBMENU_BUSINESSES'),
			'index.php?option=com_businesses&view=businesses',
			$vName == 'businesses'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_BUSINESSES_SUBMENU_LOCATIONS'),
			'index.php?option=com_businesses&view=locations',
			$vName == 'businesses'
		);
		JSubMenuHelper::addEntry(
