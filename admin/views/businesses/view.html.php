 ...
 * @since		1.6
 */
class BusinessesViewBusinesses extends JView
{
	protected $items;
	...
	{
		$canDo	= BusinessesHelper::getActions($this->state->get('filter.category_id'));
		$user		= JFactory::getUser();
		JToolBarHelper::title(JText::_('COM_BUSINESSES_BUSINESSES_TITLE'), 'business.png');

		if ($canDo->get('core.create') || (count($user->getAuthorisedCategories('com_businesses', 'core.create'))) > 0 ) {
