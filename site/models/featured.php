 ...
 */
class BusinessesModelFeatured extends BusinessesModelArticles
{
	/**
	 * Constructor.
	 *
	...
	function getListQuery($resolveFKs = true)
	{
		...
		$query->join('INNER', '#__businesses_frontpage AS fp ON fp.swaplocal_id = a.id');
